...
test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.o: /ws/src/nav2/nav2_behavior_tree/test/plugins/action/test_clear_costmap_service.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/ws/src/nav2/build/nav2_behavior_tree/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.o"
	cd /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.o -c /ws/src/nav2/nav2_behavior_tree/test/plugins/action/test_clear_costmap_service.cpp
...
test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.i: cmake_force
	...
	cd /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /ws/src/nav2/nav2_behavior_tree/test/plugins/action/test_clear_costmap_service.cpp > CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.i
...
test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.s: cmake_force
	...
	cd /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /ws/src/nav2/nav2_behavior_tree/test/plugins/action/test_clear_costmap_service.cpp -o CMakeFiles/test_action_clear_costmap_service.dir/test_clear_costmap_service.cpp.s
...
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_c.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_c.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_cpp.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_cpp.so
...
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_util/lib/libnav2_util_core.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_c.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_c.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_c.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_c.so
test/plugins/action/test_action_clear_costmap_service: /ws/src/nav2/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_cpp.so
...
test/plugins/action/test_action_clear_costmap_service: test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/ws/src/nav2/build/nav2_behavior_tree/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test_action_clear_costmap_service"
	cd /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test_action_clear_costmap_service.dir/link.txt --verbose=$(VERBOSE)
...
test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/clean:
	cd /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action && $(CMAKE_COMMAND) -P CMakeFiles/test_action_clear_costmap_service.dir/cmake_clean.cmake
...
test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/depend:
	cd /ws/src/nav2/build/nav2_behavior_tree && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /ws/src/nav2/nav2_behavior_tree /ws/src/nav2/nav2_behavior_tree/test/plugins/action /ws/src/nav2/build/nav2_behavior_tree /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action /ws/src/nav2/build/nav2_behavior_tree/test/plugins/action/CMakeFiles/test_action_clear_costmap_service.dir/DependInfo.cmake --color=$(COLOR)
