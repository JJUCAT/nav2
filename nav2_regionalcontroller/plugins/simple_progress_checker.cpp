...
#include "nav2_regionalcontroller/plugins/simple_progress_checker.hpp"
#include <cmath>
#include <string>
...
PLUGINLIB_EXPORT_CLASS(nav2_regionalcontroller::SimpleProgressChecker, nav2_core::ProgressChecker)
